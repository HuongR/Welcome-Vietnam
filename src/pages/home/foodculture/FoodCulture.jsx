...
import { cultureData, cultureContent } from "./cultureData.mjs";
import { foodData, foodContent } from "./foodData.mjs";
      ...
      <div className="section-block">
        <div className="image-half">
          <div className="image-grid">
            {cultureData.slice(0, 5).map((culture) => (
              <div key={culture.id} className="square">
                <img
                  src={culture.image}
                  alt={culture.title}
            ...
            <div className="square">
              <img
                src={cultureData[5].image}
                alt={cultureData[5].title}
                className="w-full h-full object-cover transition-transform duration-300 hover:scale-105"
              />
            </div>
          </div>
        ...
        <div className="image-half">
          <div className="image-grid">
            ...
            {foodData.slice(0, 4).map((food) => (
              <div key={food.id} className="square">
                <img
                  src={food.image}
                  alt={food.title}
                  className="w-full h-full object-cover transition-transform duration-300 hover:scale-105"
